    ...
    private IEnumerable<string> GetFrameworkVariables()
    {
        return CurrentFramework switch
        {
            CssFramework.Bootstrap => new[]
            {
                ...
                "--osirion-primary-color-hover: var(--bs-primary-dark, #0a58ca);",
                "--osirion-color: var(--bs-body-color, #212529);",
                "--osirion-color-light: var(--bs-secondary, #6c757d);",
                "--osirion-color-border: var(--bs-border-color, #dee2e6);",
                "--osirion-color-background: var(--bs-body-bg, #ffffff);",
                "--osirion-color-background-light: var(--bs-gray-100, #f8f9fa);",
                ...
                "--osirion-font-size-small: var(--bs-font-size-sm, 0.875rem);",
                "--osirion-font-size-tiny: var(--bs-font-size-sm, 0.75rem);",
                "--osirion-font-size-title: var(--bs-font-size-lg, 1.25rem);",
                ...
                "--osirion-color-background-active: var(--bs-primary-subtle, #cfe2ff);",
                "--osirion-color-active: var(--bs-primary, #0d6efd);",
            ...
            CssFramework.FluentUI => new[]
            {
                ...
                "--osirion-primary-color-hover: var(--accent-fill-hover, #1c833a);",
                "--osirion-color: var(--neutral-foreground-rest, #1a1a1a);",
                "--osirion-color-light: var(--neutral-foreground-hint, #717171);",
                "--osirion-color-border: var(--neutral-stroke-rest, #d6d6d6);",
                "--osirion-color-background: var(--neutral-fill-layer-rest, #ffffff);",
                "--osirion-color-background-light: var(--neutral-fill-stealth-rest, #f3f2f1);",
                ...
                "--osirion-font-size-small: var(--type-ramp-minus1-font-size, 12px);",
                "--osirion-font-size-tiny: var(--type-ramp-minus2-font-size, 10px);",
                "--osirion-font-size-title: var(--type-ramp-plus2-font-size, 20px);",
                ...
                "--osirion-color-background-active: var(--accent-fill-subtle-rest, #e6f2fc);",
                "--osirion-color-active: var(--accent-foreground-rest, #0078d4);",
                // Admin-specific variables
            ...
            CssFramework.MudBlazor => new[]
            {
                ...
                "--osirion-primary-color-hover: var(--mud-palette-primary-darken, #4538ca);",
                "--osirion-color: var(--mud-palette-text-primary, rgba(0, 0, 0, 0.87));",
                "--osirion-color-light: var(--mud-palette-text-secondary, rgba(0, 0, 0, 0.6));",
                "--osirion-color-border: var(--mud-palette-divider, rgba(0, 0, 0, 0.12));",
                "--osirion-color-background: var(--mud-palette-background, #ffffff);",
                "--osirion-color-background-light: var(--mud-palette-background-grey, #f5f5f5);",
                ...
                "--osirion-font-size-small: var(--mud-typography-body2-size, 0.875rem);",
                "--osirion-font-size-tiny: var(--mud-typography-caption-size, 0.75rem);",
                "--osirion-font-size-title: var(--mud-typography-h6-size, 1.25rem);",
                ...
                "--osirion-color-background-active: var(--mud-palette-primary-lighten, #c5c2f6);",
                "--osirion-color-active: var(--mud-palette-primary-darken, #4538ca);",
                // Admin-specific variables
            ...
            CssFramework.Radzen => new[]
            {
                ...
                "--osirion-primary-color-hover: var(--rz-primary-dark, #3d8bb1);",
                "--osirion-color: var(--rz-text-color, #212529);",
                "--osirion-color-light: var(--rz-text-secondary-color, #6c757d);",
                "--osirion-color-border: var(--rz-border, #e9ecef);",
                "--osirion-color-background: var(--rz-base-background-color, #ffffff);",
                "--osirion-color-background-light: var(--rz-base-100, #f8f9fa);",
                ...
                "--osirion-font-size-small: var(--rz-text-sm, 0.875rem);",
                "--osirion-font-size-tiny: var(--rz-text-xs, 0.75rem);",
                "--osirion-font-size-title: var(--rz-h5-font-size, 1.25rem);",
                ...
                "--osirion-color-background-active: var(--rz-primary-lighter, #daecf6);",
                "--osirion-color-active: var(--rz-primary-dark, #3d8bb1);",
                // Admin-specific variables
    ...
    private IEnumerable<string> GetDarkModeFrameworkVariables()
    {
        return CurrentFramework switch
        {
            CssFramework.Bootstrap => new[]
            {
                ...
                "--osirion-primary-color-hover: var(--bs-primary-text, #cfe2ff);",
                "--osirion-color-background: var(--bs-dark, #212529);",
                "--osirion-color-background-light: var(--bs-gray-800, #343a40);",
                "--osirion-color: var(--bs-white, #ffffff);",
                "--osirion-color-light: var(--bs-gray-300, #dee2e6);",
                "--osirion-color-border: var(--bs-gray-700, #495057);",
                // Admin-specific
            ...
            CssFramework.FluentUI => new[]
            {
                ...
                "--osirion-primary-color-hover: var(--accent-fill-hover, #60a5fa);",
                "--osirion-color-background: var(--neutral-fill-layer-rest, #1f2937);",
                "--osirion-color-background-light: var(--neutral-fill-stealth-rest, #111827);",
                "--osirion-color: var(--neutral-foreground-rest, #f3f4f6);",
                "--osirion-color-light: var(--neutral-foreground-hint, #9ca3af);",
                "--osirion-color-border: var(--neutral-stroke-rest, #4b5563);",
                // Admin-specific
            ...
            CssFramework.MudBlazor => new[]
            {
                ...
                "--osirion-primary-color-hover: var(--mud-palette-primary-lighten, #988dff);",
                "--osirion-color-background: var(--mud-palette-background, #121212);",
                "--osirion-color-background-light: var(--mud-palette-background-grey, #1e1e1e);",
                "--osirion-color: var(--mud-palette-text-primary, rgba(255, 255, 255, 0.87));",
                "--osirion-color-light: var(--mud-palette-text-secondary, rgba(255, 255, 255, 0.6));",
                "--osirion-color-border: var(--mud-palette-divider, rgba(255, 255, 255, 0.12));",
                // Admin-specific
            ...
            CssFramework.Radzen => new[]
            {
                ...
                "--osirion-primary-color-hover: var(--rz-primary-light, #8fbeeb);",
                "--osirion-color-background: var(--rz-base-900, #1a1a1a);",
                "--osirion-color-background-light: var(--rz-base-800, #323232);",
                "--osirion-color: var(--rz-text-color, #ffffff);",
                "--osirion-color-light: var(--rz-text-secondary-color, #aaaaaa);",
                "--osirion-color-border: var(--rz-border, #525252);",
                // Admin-specific
